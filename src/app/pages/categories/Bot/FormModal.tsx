...
import { Bot } from 'src/app/models'
import { botApi } from 'src/app/apis'
...
const ModalCategory: React.FC<Props> = ({
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setIsLoading(true)
                var res = await botApi.getById(modalId)
                if (res) {
    ...
    const postData = async (data: Bot) => {
        try {
            setButtonLoading(true)
            var res = await botApi.add(data)
            if (res) {
    ...
    const putData = async (data: Bot) => {
        try {
            setButtonLoading(true)
            var res = await botApi.update(modalId, data)
            if (res) {
                notification.success({
